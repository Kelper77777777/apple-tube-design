...
export function Header({ className }: HeaderProps) {
  ...
  return (
    <header className={cn("h-16 border-b border-zinc-800 bg-black/90 backdrop-blur-sm sticky top-0 z-10", className)}>
      <div className="flex items-center justify-between h-full px-6">
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              ...
              className="block w-full rounded-full bg-zinc-900 border border-zinc-700 py-2 pl-10 pr-16
                ...
                text-sm placeholder:text-zinc-400 text-white"
            />
            <button 
              type="button" 
        ...
        <div className="flex items-center space-x-4">
            ...
            <SheetContent className="bg-zinc-900 border-zinc-800 text-white">
              <div className="flex flex-col gap-6 p-2">
                ...
                <div className="border-2 border-dashed border-zinc-700 rounded-lg p-12 text-center">
                  ...
                  <button className="mt-4 bg-apple-blue text-white px-4 py-2 rounded-full text-sm">
                    SELECT FILES
                  </button>
                </div>
              </div>
          ...
          <Link to="/profile">
            <Avatar className="bg-gradient-to-br from-apple-red to-apple-blue w-8 h-8 cursor-pointer">
